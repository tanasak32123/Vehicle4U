...
export class RentingRequestController {
  ...
  @Post()
  async create(
    @Body() createRentingRequestDto: CreateRentingRequestDto,
    @Request() req,
    @Response() res,
  ) {
    const id = req.user['id'];
    const renreq = await this.rentingRequestService.create(
      id,
  ...
  @Patch('/updatestatus')
  async updateStatus(
    @Body() updateRentingRequestDto: UpdateRentingRequestDto,
    @Request() req,
    @Response() res,
  ) {
    const rentingrequest = await this.rentingRequestService.updatestatus(
      updateRentingRequestDto,
    );
