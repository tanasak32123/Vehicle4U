          ...
          <Row className="text-left">
            <Col sm={12} lg={6}>
                <>
                    ...
                    <div className={styles.date_time}>
                        <Row>
                            ...
                            <Col>
                                ...
                                id="birthday" 
                                name="birthday" 
                                onChange={(event) => {console.log(event.target.value.split('-'));setStartdate(event.target.value.trim())}}
                                className={styles.input_cal}/>
                            </Col>
                            <Col>
                                <input type="time" 
                                onChange={(event) =>{  console.log(event.target.value.split(':')); setStarttime(event.target.value.trim());}}
                                className={styles.input_cal}/>
                            </Col>
                        </Row>
                        <Row>
                            ...
                            <Col>
                                <input type="time" 
                                onChange={(event) => setEndtime(event.target.value.trim())}
                                className={styles.input_cal}/>
                            </Col>
                        </Row>
                    </div>
                  ...
                  <div className="mb-2">
                    <label htmlFor="exampleFormControlTextarea1"><h6>รายระเอียดจุดนัดพบ (รับ-คืนรถ)</h6></label>
                    <br/>
            ...
            <Col sm={12} lg={6}>
                <>
                  <div className="mb-2">
                    ...
                    <textarea className={styles.textarea} 
                    id="exampleFormControlTextarea1" 
                    onChange={(event) => {console.log(event.target.value); setInfo(event.target.value.trim())}}
                    rows={3}></textarea>
                    <div className={`${styles.feedback}`}>
                      {errors.invalid_tel}
                    </div>
                  ...
                  <div className="mb-2">
                    ...
                    <Col lg={12}>
                    <div>
                <p>ท่านได้ยอมรับข้อกำหนดทั่วไปและเงื่อนไขของกรมธรรม์ของเรา รวมถึงข้อกำหนดด้านการเช่าของ VEHICLE4U</p>
            </div>
            <div className="form-check">
                ...
                <Col lg={12}>
                <button className={styles.submit_btn} onClick={(event: any) => {handleSubmit(event);}}>ยืนยันการเช่า</button>
                </Col>
          </Row>
